...
def demo_trunk_zone_handling():
    ...
    dsm_dir = "/data2/lukas/projects/thermal_drift/data/dsm_tiles"
    ...
    try:
        ...
        print(f"   Current shade: {'YES' if metrics.current_shade else 'NO'}")
        print(f"   Last 1h fraction: {metrics.last_1h_fraction:.3f}")
        print(f"   Last 2h fraction: {metrics.last_2h_fraction:.3f}")
        print(f"   Last 4h fraction: {metrics.last_4h_fraction:.3f}")
        print(f"   Since dawn fraction: {metrics.since_dawn_fraction:.3f}")
        ...
        for i, point in enumerate(test_points):
            try:
                ...
                shade_status = "SHADE" if metrics.current_shade else "SUN"
                print(f"   Point {chr(65+i)}: {shade_status} (1h: {metrics.last_1h_fraction:.2f})")
